        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          <div className="px-6 py-6 lg:px-8 flex flex-col gap-6">
            ...
            <Formik initialValues={initialValues} validate={values => {
              ...
              //   errors.productImage = "هوووووووووووووووووی"
              return errors;
            }}
              ...
              {() => (
                <Form>
                  <div className={"flex flex-col gap-6"}>
                    ...
                    {/*    </label>*/}
                    {/*  </div>*/}
                    {/*  <ErrorMessage name="productImage" component="div" className={"text-red-500 text-xs"}/>*/}
                    {/*</div>*/}
                    <div>
                    ...
                    <div>
                      <Field className={"bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"} as={"select"} name={"categoryId"}>
                        {[
                          <option key="0" value="">
                            دسته بندی </option>,
                          fetchData
